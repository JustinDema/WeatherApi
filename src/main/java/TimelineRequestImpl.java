...
public class TimelineRequestImpl implements TimelineRequest{
    @Override
    public void timelineRequestHttpClient() throws IOException, URISyntaxException {
    ...
    @Override
    public void parseTimelineJson(String rawResult) {
        ...
        System.out.printf("Date\tMaxTemp\tMinTemp\tPrecip%n");
        for (int i = 0; i < values.length(); i++) {
            ...
            System.out.printf("%s\t%.1f\t%.1f\t%.1f%n", datetime.format(DateTimeFormatter.ISO_LOCAL_DATE), maxtemp, mintemp, pop);
        }
    }
}
